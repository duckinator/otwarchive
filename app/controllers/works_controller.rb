...
public
  ...
  def marktoread
    ...
    added_removed_text = @work.marked_for_later?(current_user) ? 'removed' : 'added'

    flash[:notice] = ts("This work was <strong>#{added_removed_text}</strong> from your #{view_context.link_to('Marked for Later list', read_later_path)}. It may take a while for changes to show up.").html_safe
